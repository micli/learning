...
### 对于第三种情况:
在这种情况下, 您必须从 Github 网站下载最新的IoT Client SDK 源代码。然后您必须用最新的IoT Client SDK与您的设备应用程序代码一起重新编译。最后, 客户必须在2017年9月24日之前通过设备的自我更新功能，升级IoT设备应用程序。如果没有达成, 客户的物联网设备将从2017年9月25日起，失去与IoT Hub的连接。
 
对于4组客户:
这是最坏的情况。因为客户必须手动升级设备。与3组情况类似, 客户必须从 Github 下载最新的IoT SDK源代码, 然后通过使用最新的 SDK 来编译应用程序。最后, 客户必须在2017年9月24日之前逐个手动升级IoT设备。
 
请采取行动, 确定您客户所属的分组, 并指导他们更新并实现业务的成功！
